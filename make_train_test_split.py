...
data_dir = "/ssd_scratch/cvit/akshat/datasets/accented_speakers"
speaker_name = "supersymo"
speaker_dir = os.path.join(data_dir, f"{speaker_name}")

label_filepath = os.path.join(speaker_dir, f"reduced_labels_filtered.txt")
