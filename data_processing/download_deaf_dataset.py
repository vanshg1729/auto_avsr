...
data_dir = "../datasets/deaf-youtube"
speaker_name = "benny"
...
def download_caption(video_id, download_dir, language_code='en'):
    ...
    command = [
        ...
        # "--all-subs",
        "--sub-format", "srt",  # Get subtitles in VTT format
...
if __name__ == "__main__":
    ...
    video_ids_file = os.path.join(speaker_dir, f"videos.txt") # Path to text file with video ids
